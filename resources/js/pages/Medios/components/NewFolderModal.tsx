    ...
    return (
        <Dialog open={open} onOpenChange={onClose}>
            <DialogContent className="max-w-md bg-white border-neutral-200 rounded-3xl p-0 overflow-hidden shadow-2xl">
                <DialogHeader className="p-6 pb-4 border-b border-neutral-100 bg-amber-50">
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="flex gap-3 pt-2">
                        ...
                        <Button
                            ...
                            className="flex-1 h-11 rounded-xl bg-amber-600 hover:bg-amber-700 text-white font-bold text-sm gap-2"
                        >
                            {processing ? (
                                <>
