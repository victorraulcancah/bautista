                ...
                <div className="space-y-6 p-6">
                    ...
                    {selectedApertura && (
                        <div className="bg-white border border-neutral-200 rounded-2xl shadow-sm overflow-hidden">
                            <div className="bg-[#00a65a] px-6 py-4 flex items-center justify-between">
                                <div>
                            ...
                            <table className="w-full text-sm min-w-[500px]">
                                ...
                                <tbody>
                                    {loadingNiveles ? (
                                        ...
                                        <tr>
                                            <td colSpan={4} className="py-10 text-center text-sm text-neutral-400">
                                                No hay alumnos matriculados en este periodo.
                                            </td>
                                        </tr>
                                    ) : (
                                        niveles.map((n, idx) => (
                                            <tr key={n.nivel_id} className="border-b border-neutral-100 hover:bg-neutral-50 transition-colors">
                                                ...
                                                <td className="px-6 py-4 text-center font-semibold text-neutral-800 uppercase">
                                                    {n.nombre_nivel}
                                                </td>
                                                <td className="px-6 py-4 text-center text-neutral-600">
                                                    {n.total} alumno{n.total !== 1 ? 's' : ''}
                                                </td>
