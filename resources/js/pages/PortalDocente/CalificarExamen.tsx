                    ...
                    <table className="w-full text-left">
                        <thead className="bg-[#00a65a] text-white">
                            <tr>
                                ...
                                <th className="px-6 py-4 font-black uppercase tracking-wider text-center">Estado</th>
                                ...
                                <th className="px-6 py-4 font-black uppercase tracking-wider text-center">Ver Examen</th>
                            </tr>
                        </thead>
