...
export const ReqLabel = ({ children, className }: { children: React.ReactNode; className?: string }) => (
    <Label className={`text-xs flex items-center gap-1.5 font-semibold text-neutral-700 ${className || ''}`}>
        <Circle size={8} className="text-rose-700 fill-rose-700 shrink-0" />
        {children}
    </Label>
);

export const OptLabel = ({ children, className }: { children: React.ReactNode; className?: string }) => (
    <Label className={`text-xs flex items-center gap-1.5 font-semibold text-neutral-700 ${className || ''}`}>
