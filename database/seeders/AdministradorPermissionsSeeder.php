...
/**
 * Seeder de permisos para el rol: administrador
 * Total: 112 permisos
 *
 * Uso: php artisan db:seed --class=AdministradorPermissionsSeeder
 */
class AdministradorPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $this->command->info('Administrador: ' . count($permissions) . ' permisos aplicados.');
    }
}
